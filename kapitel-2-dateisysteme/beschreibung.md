...
<!--sec data-title="/bin" data-id="section0" data-show=true ces-->
### /bin
...
<!--endsec-->
<!--sec data-title="/boot" data-id="section1" data-show=true ces-->
### /boot
...
<!--endsec-->
<!--sec data-title="/dev" data-id="section2" data-show=true ces-->
### /dev
