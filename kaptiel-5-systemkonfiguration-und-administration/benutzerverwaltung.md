...
* Ein User ist einer **Hauptgruppe \(GID\)**, die den gleichen Namen trägt wie sein Username und ggfls. weiteren Gruppen zugeordnet. Über den Befehl 'id &lt;benutzername&gt;' wird angezeigt, welcher UID, Hauptgruppe und welchen weiteren Gruppen der Benutzer zugeordnet ist.
